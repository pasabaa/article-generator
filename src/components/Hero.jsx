...
export const Hero = () => {
  ...
  return (
    <div className='px-4 pt-6 mt-16'>
        <img className='mb-3' width={300} src={'/static/writepro.png'} alt="WritePro Logo" />
        <h1 className='text-4xl title'>Generador de ideas, párrafos e información para artículos.</h1>
